...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    map.on("spatialreferencechange", event => context.emit("spatialreferencechange", event));
    map.on("baselayerchangestart", event => context.emit("baselayerchangestart", event));
    map.on("baselayerchangeend", event => context.emit("baselayerchangeend", event));
    map.on("setbaselayer", event => context.emit("setbaselayer", event));
    map.on("baselayerload", event => context.emit("baselayerload", event));
    map.on("baselayerremove", event => context.emit("baselayerremove", event));
    ...
    map.on("dragrotatestart", event => context.emit("dragrotatestart", event));
    ...
    map.on("animateinterrupted", event => context.emit("animateinterrupted", event));
    ...
    map.on("fullscreenstart", event => context.emit("fullscreenstart", event));
    map.on("fullscreenend", event => context.emit("fullscreenend", event));
    map.on("cancelfullscreen", event => context.emit("cancelfullscreen", event));
