<template>
  <div class="map-content">
    <mt-init-map ref="mapRef" :options="mapOptions">
      <mt-group-gl-layer>
        <mt-vector-tile-layer :options="options" />
      </mt-group-gl-layer>
    </mt-init-map>
  </div>
</template>
...
let options = {
  urlTemplate:
    "https://hbaoyun.cn:9006/map-imgdate-serve/biz-api/eemp/search/v1/map-title/layerXYZ/lanzhoutilescoutry/{z}/{x}/{y}",
  ...
  style: [
    {
      ...
      symbol: {
        polygonBloom: false,
        polygonFill: [
          0.0509803921568627, 0.0941176470588235, 0.1764705882352941, 1
        ],
        polygonOpacity: 1,
    ...
    },
    {
      ...
      symbol: {
        ...
        lineCap: "butt",
        lineColor: [
          0.2980392156862745, 0.5372549019607843, 0.9450980392156863, 1
        ],
    ...
    },
    {
      ...
      symbol: {
        polygonBloom: false,
        polygonFill: [
          0.1058823529411765, 0.4823529411764706, 0.2392156862745098, 1
        ],
        polygonOpacity: 1,
        polygonPatternFile: null,
        visible: true
    ...
    },
    {
      ...
      symbol: {
        polygonBloom: false,
        polygonFill: [
          0.3176470588235294, 0.6274509803921569, 0.8509803921568627, 1
        ],
        polygonOpacity: 1,
        polygonPatternFile: null,
        visible: true
    ...
    },
    {
      ...
      symbol: {
        ...
        lineCap: "butt",
        lineColor: [
          0.4705882352941176, 0.1725490196078431, 0.0392156862745098, 0.1
        ],
        lineDasharray: [0, 0, 0, 0],
        lineDashColor: [1, 1, 1, 0],
        lineDx: 0,
    ...
    },
    {
      ...
      symbol: {
        ...
        lineStrokeWidth: 0.5,
        lineStrokeColor: [
          0.4705882352941176, 0.1725490196078431, 0.0392156862745098, 1
        ],
    ...
    },
    {
      ...
      symbol: {
        ...
        textFill: [
          0.2117647058823529, 0.3764705882352941, 0.5725490196078431, 1
        ],
    ...
    },
    {
      ...
      symbol: {
        ...
        lineCap: "butt",
        lineColor: [0.73, 0.73, 0.73, 1],
        lineDasharray: [8, 8, 0, 0],
        lineDashColor: [0, 0, 0, 1],
        lineDx: 0,
        lineDy: 0,
        lineGapWidth: 0,
        lineJoin: "miter",
    ...
    },
    {
      ...
      symbol: {
        lineBloom: false,
        lineCap: "butt",
        lineColor: [1, 0.9254901960784314, 0.7294117647058824, 1],
        lineDasharray: [0, 0, 0, 0],
        lineDashColor: [1, 1, 1, 0],
        lineDx: 0,
        lineDy: 0,
        ...
        lineStrokeWidth: 0.5,
        lineStrokeColor: [
          0.992156862745098, 0.8509803921568627, 0.6431372549019608, 1
        ],
        lineJoinPatternMode: 1,
        lineWidth: {
          type: "interval",
    ...
    },
    {
      ...
      symbol: {
        lineBloom: true,
        lineCap: "butt",
        lineColor: [1, 0.9254901960784314, 0.7294117647058824, 0],
        lineDasharray: [0, 0, 0, 0],
        lineDashColor: [1, 1, 1, 0],
        lineDx: 0,
        lineDy: 0,
        ...
        lineStrokeWidth: 0.5,
        lineStrokeColor: [
          0.992156862745098, 0.8509803921568627, 0.6431372549019608, 0
        ],
        lineJoinPatternMode: 0,
        lineWidth: {
          type: "interval",
    ...
    // },
    {
      ...
      symbol: {
        ...
        lineStrokeColor: [
          0.992156862745098, 0.8509803921568627, 0.6431372549019608, 1
        ], //0.7764705882352941, 0.6431372549019608, 0.2509803921568627, 1
        lineJoinPatternMode: 1,
        lineWidth: {
          type: "interval",
          default: 0,
    ...
    },
    {
      ...
      symbol: {
        ...
        lineCap: "butt",
        lineColor: [
          0.6823529411764706, 0.6392156862745098, 0.4313725490196078, 0
        ],
        lineDasharray: [0, 0, 0, 0],
        lineDashColor: [1, 1, 1, 0],
        lineDx: 0,
